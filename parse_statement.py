...
def while_loop_replacer(string):
    temp = string
    if 'range of' in string:
        temp = string.replace('range of','range(')
    return temp

def print_replacer(string):
    temp = string
    if 'print' in temp:
        temp.replace('print','print(')
    return temp
...
def parse_statement(statement,key):
    ...
    if key=='if':
        ...
        temp = while_loop_replacer(number_replacer(statement))
    elif key=='print statement':
        temp = print_replacer(statement)
    return temp
